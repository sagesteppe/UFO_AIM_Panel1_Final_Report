...
knit: (function(inputFile, encoding) 
  { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), 'Section_16.pdf')) })
output:
...
At Southwest Conservation Corps, whom all hiring was through, we thank Cassandra Owens, Talavi Cook, and Rylee Hostrawser.
