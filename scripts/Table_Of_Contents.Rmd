...
\begin{enumerate}
    ...
    \item 2) Ecological Side Descriptions Completion Assessment \dotfill pizza
    \item 3) Increase Range around Narrow Ecological Site Benchmarks \dotfill wings
    \item 4) Ecological Site Description and Ecological Site Group Comparison - Vegetation 'Benchmarks' \dotfill filler
    \item 5) An Assessment of Drought Conditions \dotfill 4 points
    \item 6) An overview of the Analytical Sections \dotfill 5 points
    \item 7) Bareground \dotfill 6 point
    \item 8) Soil Stability \dotfill 7 point
    \item 9) Noxious Species \dotfill beez
    \item 10) Plant Functional Diversity - Cover \dotfill hamburger
    \item 11) Plant Functional Diversity - Species \dotfill granola
    \item 12) Rare Species \dotfill peach
    \item 13) Floristic Quality Index \dotfill pear
    \item 14) Glossary \dotfill apple
    \item 15) Acknowledgements \dotfill fries
\end{enumerate} 
