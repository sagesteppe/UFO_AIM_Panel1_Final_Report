...
\begin{enumerate}
    ...
    \item 1) Sample Design, Stratification, and Plots Weights \dotfill 3
    \item 2) Ecological Side Descriptions Completion Assessment \dotfill pp
    \item 3) Increase Range around Narrow Ecological Site Benchmarks \dotfill pp
    \item 4) Ecological Site Description and Ecological Site Group Comparison - Vegetation 'Benchmarks' \dotfill pp
    \item 5) An Assessment of Drought Conditions \dotfill 4 pp
    \item 6) An overview of the Analytical Sections \dotfill 5 pp
    \item 7) Bare ground \dotfill 6 pp
    \item 8) Soil Stability \dotfill 7 pp
    \item 9) Noxious Species \dotfill pp
    \item 10) Plant Functional Diversity - Cover \dotfill pp
    \item 11) Plant Functional Diversity - Species \dotfill pp
    \item 12) Rare Species \dotfill pp
    \item 13) Floristic Quality Index \dotfill pp
    \item 14) Glossary \dotfill pp
    \item 15) Acknowledgements \dotfill pp
\end{enumerate} 
...
\begin{enumerate}
    ...
    \item \textbf{Figure 8.1} \dotfill xx
    ...
    \item \textbf{Figure 11.2} Number of Species Observed per Coarse Functional Group \dotfill xx  
    
    Stylized topographic map of the area of analysis
\end{enumerate} 
